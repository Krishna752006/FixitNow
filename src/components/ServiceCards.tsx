...
const ServiceCards = ({ selectedCategory, onBookService }: ServiceCardsProps) => {
  const servicesByCategory: Record<string, Array<{title: string; description: string; duration: string; price: string}>> = {
    ...
    'Electrical': [
      { title: 'Outlet Installation', description: 'Install new electrical outlets', duration: '1-2 hours', price: '$50' },
      ...
      { title: 'Ceiling Fan Installation', description: 'Install ceiling fans with lights', duration: '2-3 hours', price: '$95' },
    ...
    'Cleaning': [
      { title: 'Deep House Cleaning', description: 'Complete home deep cleaning', duration: '4-6 hours', price: '$150' },
    ...
    'Painting': [
      ...
      { title: 'Exterior Painting', description: 'Paint exterior walls and surfaces', duration: '2-3 days', price: '$450' },
      ...
      { title: 'Cabinet Painting', description: 'Refinish kitchen cabinets', duration: '2-3 days', price: '$280' },
    ...
    'Landscaping': [
      { title: 'Lawn Mowing', description: 'Regular lawn maintenance and mowing', duration: '1-2 hours', price: '$50' },
      { title: 'Garden Design', description: 'Professional garden planning and design', duration: '1-2 days', price: '$250' },
